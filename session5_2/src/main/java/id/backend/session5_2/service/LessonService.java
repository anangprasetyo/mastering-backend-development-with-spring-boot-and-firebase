...
import id.backend.session5_2.dto.lesson.LessonPostRequestDTO;
import id.backend.session5_2.dto.lesson.LessonPutRequestDTO;
import id.backend.session5_2.model.Lesson;
import id.backend.session5_2.model.Student;
import id.backend.session5_2.repository.LessonRepository;
...
public class LessonService {
    ...
    public LessonGetRequestDTO convertToGetRequestDTO(Lesson lesson) {
        return LessonGetRequestDTO.builder()
                .id(lesson.getId())
                .name(lesson.getName())
                .student_id(lesson.getStudent().getId())
                .build();
    }
    ...
    // create new lesson
    @Transactional
    public LessonGetRequestDTO createLesson(@Valid LessonPostRequestDTO lessonDto) {
    ...
    // update lesson
    @Transactional
    public LessonGetRequestDTO updateLesson(@Valid LessonPutRequestDTO lessonDto, int id) {
